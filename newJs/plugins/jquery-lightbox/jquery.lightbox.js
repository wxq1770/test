	...
	$.fn.lightbox = function(options) {
		...
		*/
		function initialize() {
			...
			var outerImage = '<div id="outerImageContainer"><div id="imageContainer"><img id="lightboxImage" /><div id="hoverNav"><a href="#" title="' + opts.strings.prevLinkTitle + '" id="prevLink"></a><a href="#" id="nextLink" title="' + opts.strings.nextLinkTitle + '"></a></div><div id="loading"><a href="#" id="loadingLink"><img src="'+opts.fileLoadingImage+'"></a></div></div></div>';
			...
			imageData += '<a href="#" id="bottomNavClose" title="' + opts.strings.closeTitle + '"><img src="'+opts.fileBottomNavCloseImage+'"></a></div></div></div>';
